...
" Enable highlighting of all search results
set hlsearch
"------------------------------------------------------------
" Must have options {{{1
"
...
" copy paste in visual mode. command will not work. use ctrl
" vmap <C-x> :!pbcopy<CR>  
...
"lint entire file and return cursor
map <F7> mzgg=G`z
